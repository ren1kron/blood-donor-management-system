...
public interface BookingRepository extends JpaRepository<Booking, UUID> {
    ...
    @Query("SELECT COUNT(b) FROM Booking b WHERE b.slot.id = :slotId " +
           "AND b.status IN (ifmo.se.coursach_back.model.BookingStatus.PENDING_QUESTIONNAIRE, " +
           "ifmo.se.coursach_back.model.BookingStatus.CONFIRMED, " +
           "ifmo.se.coursach_back.model.BookingStatus.BOOKED) " +
    ...
    @Query("SELECT b FROM Booking b " +
           "JOIN FETCH b.donor " +
           "JOIN FETCH b.slot " +
           "WHERE b.slot.purpose = ifmo.se.coursach_back.model.SlotPurpose.EXAMINATION " +
