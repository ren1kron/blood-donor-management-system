...
import ifmo.se.coursach_back.admin.dto.AdminCreateAccountResponse;
import ifmo.se.coursach_back.admin.dto.AdminCreateStaffProfileRequest;
import ifmo.se.coursach_back.admin.dto.AdminCreateStaffProfileResponse;
import ifmo.se.coursach_back.admin.dto.AdminDonorSummaryResponse;
import ifmo.se.coursach_back.admin.dto.AdminDonorSummaryRow;
import ifmo.se.coursach_back.admin.dto.AdminStaffSummaryResponse;
import ifmo.se.coursach_back.admin.dto.AdminUpdateAccountRequest;
...
public class AdminAccountService {
    ...
    public List<AdminDonorSummaryResponse> listDonors() {
        List<AdminDonorSummaryRow> rows = donorProfileRepository.findDonorSummaries();
        return rows.stream()
